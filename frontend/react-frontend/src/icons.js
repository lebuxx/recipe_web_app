...
<svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 40 40" fill="none">
    <path d="M5 14.9997L20 3.33301L35 14.9997V33.333C35 34.2171 34.6488 35.0649 34.0237 35.69C33.3986 36.3152 32.5507 36.6663 31.6667 36.6663H8.33333C7.44928 36.6663 6.60143 36.3152 5.97631 35.69C5.35119 35.0649 5 34.2171 5 33.333V14.9997Z" stroke="#333333" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M15 36.667V19.667H25V36.667" stroke="#333333" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={40} height={40} color={"#333333"} fill={"none"} {...props}>
    <path d="M21 16.9286V10C21 6.22876 21 4.34315 19.8284 3.17157C18.6569 2 16.7712 2 13 2H12C8.22876 2 6.34315 2 5.17157 3.17157C4 4.34315 4 6.22876 4 10V19.5" stroke="#333333" strokeWidth="1.5" strokeLinecap="round"></path>
    <path d="M21 17H6.5C5.11929 17 4 18.1193 4 19.5C4 20.8807 5.11929 22 6.5 22H21" stroke="#333333" strokeWidth="1.5" strokeLinecap="round"></path>
    <path d="M21 22C19.6193 22 18.5 20.8807 18.5 19.5C18.5 18.1193 19.6193 17 21 17" stroke="#333333" strokeWidth="1.5" strokeLinecap="round"></path>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={40} height={40} color={"#333333"} fill={"none"} {...props}>
    <path d="M19.5 5.5L18.8803 15.5251C18.7219 18.0864 18.6428 19.3671 18.0008 20.2879C17.6833 20.7431 17.2747 21.1273 16.8007 21.416C15.8421 22 14.559 22 11.9927 22C9.42312 22 8.1383 22 7.17905 21.4149C6.7048 21.1257 6.296 20.7408 5.97868 20.2848C5.33688 19.3626 5.25945 18.0801 5.10461 15.5152L4.5 5.5" stroke="#333333" strokeWidth="1" strokeLinecap="round"></path>
    <path d="M3 5.5H21M16.0557 5.5L15.3731 4.09173C14.9196 3.15626 14.6928 2.68852 14.3017 2.39681C14.215 2.3321 14.1231 2.27454 14.027 2.2247C13.5939 2 13.0741 2 12.0345 2C10.9688 2 10.436 2 9.99568 2.23412C9.8981 2.28601 9.80498 2.3459 9.71729 2.41317C9.32164 2.7167 9.10063 3.20155 8.65861 4.17126L8.05292 5.5" stroke="#333333" strokeWidth="1" strokeLinecap="round"></path>
    <path d="M9.5 16.5L9.5 10.5" stroke="#333333" strokeWidth="1" strokeLinecap="round"></path>
    <path d="M14.5 16.5L14.5 10.5" stroke="#333333" strokeWidth="1" strokeLinecap="round"></path>
  </svg>
);
